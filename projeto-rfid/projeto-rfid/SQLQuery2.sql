...
insert into aula (id, horario_aula, nome_materia_fk, numero_sala_fk, nome_professor) values (1, '2022-11-21 19:05', 'Banco de Dados', 70, 'Eduardo')
insert into aula (id, horario_aula, nome_materia_fk, numero_sala_fk, nome_professor) values (2, '2022-11-21 21:05', 'Banco de Dados', 82, 'Eduardo')
insert into aula (id, horario_aula, nome_materia_fk, numero_sala_fk, nome_professor) values (3, '2022-11-23 19:05', 'Fenômenos de transporte', 82, 'Calvo')
insert into aula (id, horario_aula, nome_materia_fk, numero_sala_fk, nome_professor) values (4, '2022-11-23 21:05', 'Linguagem de Programação 1', 70, 'Eduardo')
insert into aula (id, horario_aula, nome_materia_fk, numero_sala_fk, nome_professor) values (5, '2022-11-23 19:05', 'Fenômenos de transporte', 82, 'Calvo')

insert into aluno (id, nome_aluno, nome_curso_fk, periodo_curso_fk, semestre_curso_fk, senha) values (082200001, 'Eduardo', 'Engenharia da Computação', 'Noturno', 5, '123')
insert into aluno (id, nome_aluno, nome_curso_fk, periodo_curso_fk, semestre_curso_fk, senha) values (082200037, 'Milena', 'Engenharia da Computação', 'Noturno', 5, '123')
